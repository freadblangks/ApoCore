...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "debuff",         rbac::RBAC_PERM_COMMAND_VIP_DEBUFF,         false, &HandleVipDebuffCommand,             "", NULL },
            { "bank",           rbac::RBAC_PERM_COMMAND_VIP_BANK,         false, &HandleVipBankCommand,               "", NULL },
            { "repair",         rbac::RBAC_PERM_COMMAND_VIP_REPAIR,         false, &HandleVipRepairCommand,             "", NULL },
            { "resettalents",   rbac::RBAC_PERM_COMMAND_VIP_RESET_TALENTS,         false, &HandleVipResetTalentsCommand,       "", NULL },
            { "taxi",           rbac::RBAC_PERM_COMMAND_VIP_TAXI,         false, &HandleVipTaxiCommand,               "", NULL },
            { "home",           rbac::RBAC_PERM_COMMAND_VIP_HOME,         false, &HandleVipHomeCommand,               "", NULL },
            { "capital",        rbac::RBAC_PERM_COMMAND_VIP_CAPITAL,         false, &HandleVipCapitalCommand,            "", NULL },
