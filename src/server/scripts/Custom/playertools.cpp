	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
	{
		...
		switch (action)
		{
			...
			case 50: // Morph Menu	
		        ...
		        player->ADD_GOSSIP_ITEM(8, "|TInterface/ICONS/Thrown_1H_Harpoon_D_01Blue:30|t |cff0000ff Human - Female", GOSSIP_SENDER_MAIN, 23);
				...
				player->ADD_GOSSIP_ITEM(8, "|TInterface/ICONS/Thrown_1H_Harpoon_D_01Blue:30|t |cffff0000 Tauren - Male", GOSSIP_SENDER_MAIN, 15);
				player->ADD_GOSSIP_ITEM(8, "|TInterface/ICONS/Thrown_1H_Harpoon_D_01Blue:30|t |cffff0000 Tauren - Female", GOSSIP_SENDER_MAIN, 16);
				player->ADD_GOSSIP_ITEM(8, "|TInterface/ICONS/Thrown_1H_Harpoon_D_01Blue:30|t |cffff0000 Blood Elf - Male", GOSSIP_SENDER_MAIN, 17);
			    player->ADD_GOSSIP_ITEM(8, "|TInterface/ICONS/Thrown_1H_Harpoon_D_01Blue:30|t |cffff0000 Blood Elf - Female", GOSSIP_SENDER_MAIN, 18);
			...
			case 60:
				...
				player->ADD_GOSSIP_ITEM(4, "|TInterface/ICONS/Achievement_Arena_2v2_3:30|t |cffFF4500 100 PvP Badge --> 1000 Honor Pts."                     , GOSSIP_SENDER_MAIN, 37); 
				...
				player->ADD_GOSSIP_ITEM(4, "|TInterface/ICONS/Achievement_Arena_2v2_3:30|t |cffFF4500 100 Arena Pts. --> 1000 Honor Pts."			, GOSSIP_SENDER_MAIN, 39);
