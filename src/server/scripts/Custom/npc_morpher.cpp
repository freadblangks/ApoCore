	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
	{
		...
		case ACTION_NAGA_LORD:
			...
			player->SetDisplayId(DISPLAY_ID_NAGA_LORD);
			{
				...
				CharacterDatabase.PExecute("INSERT INTO `character_scale` (`guid`, `scale`, `comment`) VALUES(%u, 0.2, 'Naga Lord');", player->GetGUID());
			}
			player->SetFloatValue(OBJECT_FIELD_SCALE_X, 0.20f);
			break;
		...
		case ACTION_WORGEN:
			...
			player->SetDisplayId(DISPLAY_ID_WORGEN);
			{
				...
				CharacterDatabase.PExecute("DELETE FROM `character_scale` WHERE guid = %u;", player->GetGUID());
				CharacterDatabase.PExecute("INSERT INTO `character_scale` (`guid`, `scale`, `comment`) VALUES(%u, 1, 'Worgen');", player->GetGUID());
			}
		...
		case ACTION_PANDAREN_MONK:
			...
			player->SetDisplayId(DISPLAY_ID_PANDAREN_MONK);
			{
				...
				CharacterDatabase.PExecute("DELETE FROM `character_scale` WHERE guid = %u;", player->GetGUID());
				CharacterDatabase.PExecute("INSERT INTO `character_scale` (`guid`, `scale`, `comment`) VALUES(%u, 3, 'Panda');", player->GetGUID());
			}
		...
		case ACTION_ALGALON:
			...
			player->SetDisplayId(DISPLAY_ID_ALGALON);
			{
				...
				CharacterDatabase.PExecute("DELETE FROM `character_scale` WHERE guid = %u;", player->GetGUID());
				CharacterDatabase.PExecute("INSERT INTO `character_scale` (`guid`, `scale`, `comment`) VALUES(%u, 0.20, 'Alfalon');", player->GetGUID());
			}
			player->SetFloatValue(OBJECT_FIELD_SCALE_X, 0.20f);
			break;
		...
		case ACTION_VIKING:
			...
			player->SetDisplayId(DISPLAY_ID_VIKING);
			{
				...
				CharacterDatabase.PExecute("DELETE FROM `character_scale` WHERE guid = %u;", player->GetGUID());
				CharacterDatabase.PExecute("INSERT INTO `character_scale` (`guid`, `scale`, `comment`) VALUES(%u, 0.5, 'Viking');", player->GetGUID());
			}
...
/*
		...
		case ACTION_SCALE_VRYKUL_DEFAULT:
			...
			{
				CharacterDatabase.PExecute("DELETE FROM `character_scale` WHERE guid = %u;", player->GetGUID());
				CharacterDatabase.PExecute("INSERT INTO `character_scale` (`guid`, `scale`, `comment`) VALUES(%u, 0.65, 'Vrykul Default');", player->GetGUID());
			}
			player->SetFloatValue(OBJECT_FIELD_SCALE_X, 0.8f);
			break;
		...
		case ACTION_SCALE_ALGALON_FIX:
			...
			{
				CharacterDatabase.PExecute("DELETE FROM `character_scale` WHERE guid = %u;", player->GetGUID());
				CharacterDatabase.PExecute("INSERT INTO `character_scale` (`guid`, `scale`, `comment`) VALUES(%u, 0.20, 'Alagon Fix');", player->GetGUID());
			}
