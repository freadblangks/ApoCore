...
#include "../../../scripts/Custom/Transmogrification.h" //alfa 01.07.2014
...
void Player::SetVisibleItemSlot(uint8 slot, Item* pItem)
{
    if (pItem)
    {
	if (uint32 entry = sTransmogrification->GetFakeEntry(pItem)) //alfa 01.07.2014
	    SetUInt32Value(PLAYER_VISIBLE_ITEM_1_ENTRYID + (slot * 2), entry); //alfa 01.07.2014
	else //alfa 01.07.2014
		SetUInt32Value(PLAYER_VISIBLE_ITEM_1_ENTRYID + (slot * 2), pItem->GetEntry()); //alfa 01.07.2014
...
void Player::MoveItemFromInventory(uint8 bag, uint8 slot, bool update)
{
    ...
    {
		sTransmogrification->DeleteFakeEntry(this, it); //alfa 01.07.2014
