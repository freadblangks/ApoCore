...
void AddSC_PWS_Transmogrification(); //alfa 01.07.2014
void AddSC_CS_Transmogrification(); //alfa 01.07.2014
void AddSC_DuelReset(); //alfa 01.07.2014
void AddSC_arena_spectator_script(); // alfa 03.07.2014
void AddSC_Teleporter_NPC_CreatureScript(); //alfa 03.07.2014
void AddSC_level_rewards(); //alfa 04.07.2014
void AddSC_vip_commandscript(); //alfa 04.07.2014
void AddSC_beastmaster_npc(); //alfa 04.07.2014
void AddSC_Top5_Killers(); //alfa 04.07.2014
void AddSC_PvP_System(); //alfa 04.07.2014
void AddSC_World_Chat(); //alfa 05.07.2014
void AddSC_npc_morpher(); //alfa 17.07.2014
void AddSC_npc_vip_vendor(); //alfa 19.07.2014
#endif
...
void AddCustomScripts()
{
	...
	AddSC_PWS_Transmogrification(); //alfa 01.07.2014
	AddSC_CS_Transmogrification(); //alfa 01.07.2014
	AddSC_DuelReset(); //alfa 01.07.2014
	AddSC_arena_spectator_script(); //alfa 03.07.2014
	AddSC_Teleporter_NPC_CreatureScript(); //alfa 03.07.2014
	AddSC_level_rewards(); //alfa 04.07.2014
	AddSC_vip_commandscript(); //alfa 04.07.2014
	AddSC_beastmaster_npc(); //alfa 04.07.2014
	AddSC_Top5_Killers(); //alfa 04.07.2014
	AddSC_PvP_System(); //alfa 04.07.2014
	AddSC_World_Chat(); //alfa 05.07.2014
	AddSC_npc_morpher(); //alfa 17.07.2014
	AddSC_npc_vip_vendor(); //alfa 19.07.2014
#endif
}
