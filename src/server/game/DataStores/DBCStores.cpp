...
DBCStorage <ItemDisplayInfoEntry> sItemDisplayInfoStore(ItemDisplayTemplateEntryfmt); // custom alfa 01.07.2014
...
void LoadDBCStores(const std::string& dataPath)
{
	...
	LoadDBC(availableDbcLocales, bad_dbc_files, sItemDisplayInfoStore,        dbcPath, "ItemDisplayInfo.dbc");     // custom alfa 01.07.2014
