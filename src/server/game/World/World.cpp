...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_RANDOM_BG_ITEM_REW] = sConfigMgr->GetIntDefault("RandomBG.CustomItem.Enable", false); 
    m_int_configs[CONFIG_RANDOM_BG_ITEM_ID] = sConfigMgr->GetIntDefault("RandomBG.CustomItem.ID", 49426); 
    m_int_configs[CONFIG_RANDOM_BG_WIN_COUNT] = sConfigMgr->GetIntDefault("RandomBG.CustomItem.WinCount", 3); 
    m_int_configs[CONFIG_RANDOM_BG_LOS_COUNT] = sConfigMgr->GetIntDefault("RandomBG.CustomItem.LosCount", 1); 
    ...
    //Reset Duel Cooldown alfa 01.07.2014
    m_bool_configs[CONFIG_DUEL_RESET_COOLDOWN_ON_START] = sConfigMgr->GetBoolDefault("DuelReset.Cooldown.OnStart", false); //alfa 01.07.2014
	m_bool_configs[CONFIG_DUEL_RESET_COOLDOWN_ON_FINISH] = sConfigMgr->GetBoolDefault("DuelReset.Cooldown.OnFinish", false); //alfa 01.07.2014
	m_bool_configs[CONFIG_DUEL_RESET_COOLDOWN_ONLY_IN_ELWYNN_AND_DUROTAR] = sConfigMgr->GetBoolDefault("DuelReset.Cooldown.Only.in.Elwynn.and.Durotar", false); //alfa 01.07.2014
	m_bool_configs[CONFIG_DUEL_RESET_COOLDOWN_MAX_ENERGY_ON_START] = sConfigMgr->GetBoolDefault("DuelReset.Cooldown.Max.Energy.OnStart", false); //alfa 01.07.2014
	m_bool_configs[CONFIG_DUEL_RESET_COOLDOWN_RESET_ENERGY_ON_START] = sConfigMgr->GetBoolDefault("DuelReset.Cooldown.Reset.Energy.OnStart", false); //alfa 01.07.2014
