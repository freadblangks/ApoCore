...
enum RBACPermissions
{
	...
	// VIP
	RBAC_PERM_COMMAND_VIP_DEBUFF                            = 1005,
	RBAC_PERM_COMMAND_VIP_BANK								= 1006,
	RBAC_PERM_COMMAND_VIP_REPAIR							= 1007,
	RBAC_PERM_COMMAND_VIP_RESET_TALENTS						= 1008,
	RBAC_PERM_COMMAND_VIP_TAXI								= 1009,
	RBAC_PERM_COMMAND_VIP_HOME								= 1010,
	RBAC_PERM_COMMAND_VIP_CAPITAL							= 1011,
